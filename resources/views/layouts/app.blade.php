...
<div id="wrapper">
    ...
    <div class="topbar">
        ...
        <nav class="navbar-custom">
            ...
            <ul class="list-inline float-right mb-0">
                ...
                @include('layouts.components.notice')
    ...
    <!-- ========== Left Sidebar Start ========== -->
        @include('layouts.components.left-menu')
    <!-- Left Sidebar End -->
    ...
    <footer class="footer text-right">
        2018 © КГБУЗ "Городская больница №10, г. Барнаул".
    </footer>
...
{{--<div class="sl-mainpanel">--}}
    ...
    {{--<footer class="sl-footer">--}}
        {{--<div class="footer-left">--}}
            {{--<div class="mg-b-2">Copyright &copy; 2018. КГБУЗ Городская больница №10.</div>--}}

        {{--</div>--}}
        {{--<div class="footer-right d-flex align-items-center">--}}
            {{--<div>Made by KalashnikovOV.</div>--}}
        {{--</div>--}}
    {{--</footer>--}}
{{--</div><!-- sl-mainpanel -->--}}
{{--<!-- ########## END: MAIN PANEL ########## -->--}}
