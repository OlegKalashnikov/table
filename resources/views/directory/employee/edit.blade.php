...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title m-t-0">Редактирование данных</h4>
                    <div class="p-20">
                        <form role="form" method="POST" action="{{route('directory.employee.update', $employees->id)}}">
                            {{csrf_field()}}
                            {{method_field('patch')}}
                            <div class="form-group row">
                                <label for="" class="col-sm-4 form-control-label">ФИО сотрудника<span class="text-danger">*</span></label>
                                <div class="col-sm-7">
                                    <input type="text" name="employee" class="form-control" value="{{$employees->employee}}">
