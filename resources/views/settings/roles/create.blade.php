...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col-xl-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">Создание роли</li>
                    </ol>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title m-t-0">Создание роли</h4>

                    <div class="p-20">
                        <form role="form" action="{{route('settings.role.store')}}" method="POST">
                            {{csrf_field()}}
...
{{--@section('content')--}}
    {{--<nav class="breadcrumb sl-breadcrumb">--}}
        ...
        {{--<span class="breadcrumb-item active">Создание роли</span>--}}
    {{--</nav>--}}
        ...
        {{--<div class="row row-sm mg-t-20">--}}
            ...
            {{--<div class="col-xl-6 mg-t-25 mg-xl-t-0">--}}
                {{--<div class="card pd-20 pd-sm-40 form-layout form-layout-5">--}}
                    {{--<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-25">Создание роли</h6>--}}
